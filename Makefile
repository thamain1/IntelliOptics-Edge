...
# Allow providing the IntelliOptics token via environment variable.
...
helm-local:
       helm upgrade -i -n default ${HELM_ARGS} ${HELM_TOKEN_ARG} --set=edgeEndpointTag=dev ${HELM_RELEASE_NAME} deploy/helm/groundlight-edge-endpoint
