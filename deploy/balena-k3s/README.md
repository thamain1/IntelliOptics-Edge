...
REGISTRY_SERVER - container registry host (for example, ghcr.io)
REGISTRY_NAMESPACE - namespace/project that contains the edge images
REGISTRY_USERNAME - username with permission to pull the images
REGISTRY_PASSWORD - access token/password for the container registry user
