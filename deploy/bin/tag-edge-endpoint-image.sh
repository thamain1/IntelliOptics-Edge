...
ACR_NAME=${ACR_NAME:-$(echo "${ACR_LOGIN_SERVER}" | cut -d'.' -f1)}
...
echo "Logging into Azure Container Registry ${ACR_NAME} (${ACR_URL})"
...
echo "✅ Image successfully tagged in Azure Container Registry: $ACR_REPO:$NEW_TAG"
