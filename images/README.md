This directory contains images used in the documentation. The excalidraw diagram images contain metadata that let's them be updated when you need to make tweaks.
